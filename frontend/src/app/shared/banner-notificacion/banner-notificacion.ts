  ...
  template: `
      ...
      <div class="d-flex align-items-center gap-2 text-truncate">
        ...
        <div class="text-truncate">
          ...
          <span class="ms-2 d-none d-sm-inline" style="opacity: 0.85;">- {{ notificacion.mensaje }}</span>
        </div>
      </div>

      <button class="btn btn-close-custom p-0 ms-3 flex-shrink-0 d-flex align-items-center justify-content-center" (click)="cerrar()">
